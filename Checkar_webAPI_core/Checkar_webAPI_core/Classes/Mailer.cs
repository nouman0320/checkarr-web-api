...
namespace Checkar_webAPI_core.Classes
{
    public class Mailer
    {
        ...
        public void sendRecoveryMail(String email_to, JwtSecurityToken recoveryToken, String recoveryCode)
        {
            ...
            System.Diagnostics.Debug.WriteLine("ACTIVATION TOKEN => " + recoveryToken);
            System.Diagnostics.Debug.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++++");
        }

        public void sendActivationMail(String email_to, JwtSecurityToken activationToken, String activationCode)
        {
